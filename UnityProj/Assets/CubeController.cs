...
public class CubeController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        springMaxDeviation = spring.transform.position.x - (spring.transform.localScale.y/(spring.transform.localScale.y / 0.7f)); //Maximale Auslenkung gerechnet anhand der linken seite des Feders
