...
plt.savefig('../Semesterprojekt Physik Engines/images/Inelastisch/OrtJuliaAlsFunktionDerZeit.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('../Semesterprojekt Physik Engines/images/Inelastisch/ImpulsJulia.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('../Semesterprojekt Physik Engines/images/Inelastisch/ImpulsRomeo.png', dpi=300, bbox_inches='tight')
plt.show()
